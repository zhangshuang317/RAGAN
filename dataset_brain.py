...
class Dataset_brain_4(data.Dataset):
    def __init__(self,file):
        ...
        file_seg='./brats_npy/npy_train/train_seg.npy'
        #file.replace('test_t2','test_seg').replace('npy_pred','npy_test')
        file_t1='./brats_npy/npy_train/train_t1.npy'
        #file.replace('test_t2','pred_t1')
        file_t1ce='./brats_npy/npy_train/train_t1ce.npy'
        #file.replace('test_t2','pred_t1ce')
        file_flair='./brats_npy/npy_train/train_flair.npy'
