...
file_path = glob.glob('./brats_npy/train/**/*_flair.nii.gz', recursive=True)
print(len(file_path))
import random
import cv2
import numpy as np
...
np.save('./brats_npy/npy_train/train_flair.npy', flair)
np.save('./brats_npy/npy_train/train_t1.npy', t1)
np.save('./brats_npy/npy_train/train_t1ce.npy', t1ce)
np.save('./brats_npy/npy_train/train_t2.npy', t2)
np.save('./brats_npy/npy_train/train_seg.npy', seg)
    ...
    for j in range(154, -1, -1):
        ...
        if b > threshold and c > threshold and d > threshold and e > threshold:
            ...
            if a > 50:
                ...
                nontumor += 1
            # l_tumor.extend(l_nontumor)
np.save('./brats_npy/npy_gan/gan_flair.npy', flair)
np.save('./brats_npy/npy_gan/gan_t1.npy', t1)
np.save('./brats_npy/npy_gan/gan_t1ce.npy', t1ce)
np.save('./brats_npy/npy_gan/gan_t2.npy', t2)
np.save('./brats_npy/npy_gan/gan_seg.npy', seg)
    ...
    for j in range(154, -1, -1):
        ...
        if b > threshold and c > threshold and d > threshold and e > threshold:
            ...
            if a > 50:
                ...
                nontumor += 1
            # l_tumor.extend(l_nontumor)
np.save('./brats_npy/npy_test/test_flair.npy', flair)
np.save('./brats_npy/npy_test/test_t1.npy', t1)
np.save('./brats_npy/npy_test/test_t1ce.npy', t1ce)
np.save('./brats_npy/npy_test/test_t2.npy', t2)
np.save('./brats_npy/npy_test/test_seg.npy', seg)